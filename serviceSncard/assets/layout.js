(() => {
  ...
  if (header) header.innerHTML = `<div class="container header-row">
    <a class="brand" href="index.html" aria-label="Сервис — главная"><img class="brand-logo" src="../zaoSncard/assets/logo2.png" alt="Сибнефтекарт" width="480" height="91"><span class="site-identity">Сервис</span></a>
